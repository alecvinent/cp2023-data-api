 ...
 * Use the [GiinfoFragmentChartLine.newInstance] factory method to
 * create an instance of this fragment.
 */
class GiinfoFragmentChartLine : Fragment() {
        ...
        response.getIndexes().enqueue(
            ...
            object :retrofit2.Callback<CompositeIndices> {
                override fun onResponse(
                    ...
                    valuesInfo?.let { drawChart(lineChart, rootView.context, it.giiIndex) }
                }
                override fun onFailure(call: retrofit2.Call<CompositeIndices>, t: Throwable) {
                    Toast.makeText(rootView.context,"No se pudieron cargar los datos. intente más tarde. Gracias y disculpe las molestias",
    ...
    companion object {
         ...
         * @return A new instance of fragment GiinfoFragmentChartLine.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            GiinfoFragmentChartLine().apply {
